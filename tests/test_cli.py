...
class OperatorCliTests(unittest.TestCase):
    ...
    def test_cli_reports_governance_crypto_and_adversarial_status(self) -> None:
        ...
        for command, key in [
            ...
            ("wallet-utxo-spendability", "spendability_hash"),
            ...
            ("migration-escrow-finality", "escrow_policy_hash"),
            ("migration-conversion-guardrails", "guardrail_hash"),
            ("migration-economics-spec", "spec_hash"),
            ("migration-economics-invariants", "invariant_report_hash"),
            ("migration-proof-registry", "registry_root"),
            ("migration-governance-quorum", "quorum_report_hash"),
            ("migration-economics-governance", "artifact_hash"),
            ("migration-economics-adversarial", "simulation_hash"),
            ...
            ("project-audit-bundle", "artifact_hash"),
